...
describe 'Shopping cart', type: :feature do
  ...
  xit 'can add the same item multiple times' do
    visit categories_path
    first(:button, 'Add to Cart').click
    first(:button, 'Add to Cart').click
    total_items = find('span.badge').text
  ...
  xit 'cannot add an item that do not exist' do
    visit categories_path
    Item.destroy_all
    first(:button, 'Add to Cart').click
  ...
  xit 'cannot add an item that are disabled' do
    visit categories_path
  ...
  xit 'can see the item quantity in the cart' do
    visit categories_path
    first(:button, 'Add to Cart').click
    first(:button, 'Add to Cart').click
    click_link 'View Cart'
  ...
  xit 'can increase the quantity of an item' do
    visit categories_path
    first(:button, 'Add to Cart').click
    click_link 'View Cart'
  ...
  xit 'can decrease the quantity of an item' do
    visit categories_path
    first(:button, 'Add to Cart').click
    first(:button, 'Add to Cart').click
    click_link 'View Cart'
  ...
  xit 'can remove an item by decreasing the quantity to 0' do
    visit categories_path
    first(:button, 'Add to Cart').click
    click_link 'View Cart'
